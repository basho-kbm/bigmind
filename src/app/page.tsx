        ...
        <section className="flex flex-col gap-6">
          ...
          <div className="max-w-3xl space-y-4">
            <h1 className="text-4xl font-semibold tracking-tight sm:text-6xl">
              Build the AI-native meditation app that actually ships in 14 days.
            </h1>
            <p className="text-lg text-stone-300 sm:text-xl">
              {appConfig.name} is the subscription meditation product for beginners, centered on
              sleep, guided by Roshi-bot, and built for fast launch velocity.
            </p>
          </div>
        </section>
